...
extern qboolean AICast_ScriptAction_Achievement_LIGHTSOFF ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_BLITZKRIEG ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_WORTHIT ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_FEMME ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_FATALE ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_BELOMORCANAL ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_GRENADESTASH ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_DOGSGOLD ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_RABINOVICH ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_KOLODEC ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_G43 ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_AMBUSH ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_NOAMBUSH ( cast_state_t * cs , char * params ) ;
extern qboolean AICast_ScriptAction_Achievement_FINISH ( cast_state_t * cs , char * params ) ;
